/**
 * This file contains the source code for a pure TypeScript LZMA compressor and
 * decompressor library. The library itself is a TypeScript port of Nathan
 * Rugg's LZMA-JS library, with a few TypeScript types and ECMAScript 6+ syntax
 * added, and with WebWorker functionality removed.
 *
 * @author Nathan Rugg, ChowderMan
 * @license AGPLv3
 * @see https://github.com/LZMA-JS/LZMA-JS
 * @see https://github.com/LZMA-JS/LZMA-JS/blob/master/src/lzma_worker.js
 * @see https://github.com/LZMA-JS/LZMA-JS/blob/master/LICENSE
...
type This$Static = {
  ...
  backRes: any,
  processedInSize: any,
  processedOutSize: any,
  finished: any,
  outSize: any,
  outBytesProcessed: any,
  tempPrices: any,
  rep0: any,
  rep1: any,
  rep2: any,
  ...
  m_PosStateMask: any,
  m_RangeDecoder: any,
  m_IsMatchDecoders: any,
  m_LiteralDecoder: any,
  m_OutWindow: any,
  m_RepLenDecoder: any,
  m_Coders: any,
  m_Decoders: any,
  m_IsRepDecoders: any,
  m_IsRepG0Decoders: any,
  m_IsRepG1Decoders: any,
  m_IsRepG2Decoders: any,
  m_IsRep0LongDecoders: any,
  m_PosSlotDecoder: any,
  m_PosDecoders: any,
  m_PosAlignDecoder: any,
  m_LenDecoder: any,
  m_Choice: any,
  m_LowCoder: any,
  m_MidCoder: any,
  ...
  m_NumPosBits: any,
  m_PosMask: any,
  m_DictionarySize: any,
  m_DictionarySizeCheck: any,
  m_Encoders: any,
  HASH_ARRAY: any,
  _cutValue: any,
  _keepSizeBefore: number,
  _keepSizeAfter: number,
  _needReleaseMFStream: any,
  _bufferBase: any,
  _repDistances: any,
  _matchFinder: any,
  _writeEndMark: any,
  _lenEncoder: any,
  _numFastBytes: any,
  _dictionarySizePrev: any,
  _blockSize: number,
  _pointerToLastSafePosition: any,
  _bufferOffset: number,
  _rangeEncoder: any,
  _numDistancePairs: any,
  _finished: any,
  _isMatch: any,
  _dictionarySize: any,
  _numLiteralPosStateBits: any,
  _streamPos: number,
  _pos: number,
  _streamEndWasReached: any,
  _posStateBits: any,
  _stream: any,
  _posLimit: number;
  _cyclicBufferSize: number,
  _hashMask: number,
  _matchFinderType: any,
  _hash: any,
  _buffer: any,
  ...
  _posStateMask: any,
  _posSlotEncoder: any,
  _repMatchLenEncoder: any,
  _numLiteralContextBits: any,
  _cyclicBufferPos: number,
  _son: any,
  _additionalOffset: any,
  _numFastBytesPrev: any,
  _matchMaxLen: number,
  _previousByte: any,
  _windowSize: any,
  _state: any,
  _literalEncoder: any,
  _distancesPrices: any,
  _inStream: any,
  _optimumCurrentIndex: any,
  _isRep: any,
  _isRepG0: any,
  _isRepG1: any,
  _isRepG2: any,
  _isRep0Long: any,
  _posEncoders: any,
  _matchPriceCount: any,
  _posAlignEncoder: any,
  _alignPriceCount: any,
  _position: any,
  _cacheSize: any,
  _cache: any,
  _counters: any,
  ...
  _posSlotPrices: any,
  _alignPrices: any,
  _longestMatchLength: any,
  _distTableSize: any,
  _longestMatchWasFound: any
  charCodeAt: Function,
}

export const LZMA: any = (() => {
  const __4294967296: number = 4294967296;
  const N1_longLit: number[] = [4294967295, -__4294967296];
  const MIN_VALUE: number[] = [0, -9223372036854775808];
  const P0_longLit: number[] = [0, 0];
  const P1_longLit: number[] = [1, 0];
  ...
  function compare(
    ...
    const nega: boolean = a[1] < 0;
    const negb: boolean = b[1] < 0;
  ...
  function create(
    ...
    const diffHigh: number = valueHigh % __4294967296;
    const diffLow: number = Math.floor(valueLow / __4294967296) * __4294967296;
  ...
  function makeFromBits(
    highBits: number,
    lowBits: number,
  ) : number[] {
    const high: number = highBits * __4294967296;
    let low: number = lowBits;
  ...
  function shl(
    ...
    const twoToN: any = pwrAsDouble(n);

    newHigh = a[1] * twoToN % 1.8446744073709552E19;
    newLow = a[0] * twoToN;

    const diff: number = newLow - newLow % __4294967296;
  ...
  function shr(
    ...
    n &= 63;
    const shiftFact: number = pwrAsDouble(n);
  ...
  function $LZMAByteArrayCompressor(
    ...
    $init(
      this$static, $ByteArrayInputStream({}, data),
      this$static.output,
      fromInt(data.length),
      mode,
    );
  ...
  function $GetMatchLen(
    ...
    ++distance;
    const pby: number = this$static._bufferOffset + this$static._pos + index;
  ...
  function $MoveBlock(
    ...
    const numBytes: number = this$static._bufferOffset + this$static._streamPos - offset;
  ...
  function $Create_3(
    this$static: This$Static,
    historySize: number,
    keepAddBufferBefore: any,
    matchMaxLen: any,
    keepAddBufferAfter: any,
  ) : void {
    let cyclicBufferSize: number;
    let hs: any;
    let windowReservSize: any;
  ...
  function $CopyBlock(
    ...
    let pos: number = this$static._pos - distance - 1;
  ...
  function $Flush_0(
    ...
    const size: number = this$static._pos - this$static._streamPos;
  ...
  function $processDecoderChunk(
    this$static: This$Static,
  ) : void {
    const result: any = $CodeOneChunk(this$static.decoder);
  ...
  function $CodeOneChunk(
    this$static: This$Static,
  ) : number {
    let decoder2: any;
    let distance: any;
    let len: any;
    let numDirectBits: any;
    let posSlot: any;

    const posState: any = lowBits_0(this$static.nowPos64) & this$static.m_PosStateMask;
  ...
  function $SetDecoderProperties(
    this$static: This$Static,
    properties: any,
  ) : any {
    let dictionarySize: any;
    let i: number;
    let lc: any;
    let lp: any;
    let pb: any;
    ...
    // NOTE: If the input is bad, it might call for an insanely large
    // dictionary size, which would crash the script.
  ...
  function $CodeOneBlock(
    ...
    let baseVal: any;
    let complexState: any;
    let curByte: any;
    let distance: number;
    let footerBits: any;
    let i: number;
    let len: number;
    let lenToPosState: any;
    let matchByte: any;
    let pos: number;
    let posReduced: any;
    let posSlot: any;
    let posState: any;
    let progressPosValuePrev: any;
    let subCoder: any;
  ...
  function $GetOptimum(
    ...
    let cur: any;
    let curAnd1Price: any;
    let curAndLenCharPrice: any;
    let curAndLenPrice: any;
    let curBack: any;
    let curPrice: any;
    let currentByte: any;
    let distance: any;
    ...
    let newLen: any;
    let nextIsChar: any;
    let nextMatchPrice: any;
    let nextOptimum: any;
    let nextRepMatchPrice: any;
    let normalMatchPrice: any;
    let numAvailableBytes: any;
    let numAvailableBytesFull: any;
    let numDistancePairs: any;
    let offs: any;
    let offset: number;
    let opt: any;
    let optimum: any;
    ...
    let posPrev: any;
    let posState: any;
    let posStateNext: any;
    let price_4: any;
    let repIndex: any;
    let repLen: any;
    let repMatchPrice: any;
    let repMaxIndex: any;
    let shortRepPrice: any;
    let startLen: any;
    let state: any;
    let state2: any;
    let t: any;
  ...
  function $GetPosLenPrice(
    ...
    let price: any;
    const lenToPosState: any = GetLenToPosState(len);
  ...
  function $SetMatchFinder(
    this$static: This$Static,
    matchFinderIndex: number,
  ) : void {
    const matchFinderIndexPrev = this$static._matchFinderType;
  ...
  function $WriteEndMarker(
    ...
    const lenToPosState: number = GetLenToPosState(2);
  ...
  function $Init_3(
    ...
    let i: number;
    const numStates: number = 1 << this$static.m_NumPrevBits + this$static.m_NumPosBits;
  ...
  function $ShiftLow(
    ...
    let temp: any;
    const LowHi: any = lowBits_0(shru(this$static.Low, 32));
  ...
  function decode(
    ...
    for (; i < l; ++i, ++j) {
      ...
      if (!(x & 128)) {
        ...
        // It appears that this is binary data, so it cannot be converted to a
        // string, so just send it back.
        return utf;
      }
  ...
  function compress(
    ...
    const this$static: This$Static | any = {};
  ...
  const get_mode_obj = (() : any => {
    ...
    return (mode: any) : any => modes[mode - 1] || modes[6];
  })();
