  ...
  (async () => {
    ...
    program
      ...
      .option(
        ...
        'Checks which dependencies used by HyperFiler are available on the '
      + 'platform.',
      )
      ...
      .option(
        '--sanitize',
        'A prebuilt set of options intended to sanitize an HTML page by '
      ...
      .option(
        '--compatibility',
        'A prebuilt set of options intended to polyfill an HTML page and '
      + 'convert resources in the page into formats compatible with older '
      + 'browsers.',
      )
      .option(
        '--simple-minification',
        'A prebuilt set of options intended to perform simple minifications '
      + 'on an HTML page to make it smaller without breaking any page '
      + 'functionality.',
      )
      .option(
        '--advanced-minification',
        'A prebuilt set of options intended to perform advanced minifications '
      + 'on an HTML page to make it smaller using more aggressive '
      + 'minifications that may result in breaking page functionality.',
      )
      .option(
        '--hyper-minification',
        'A prebuilt set of options intended to perform hyper minifications on '
    ...
    const hyperFilerOptions: HyperFilerOptions = {
      url: args[0],
      ...options,
    };

    // Creating the hyper filer object and running the hyper filing process.
    const hyperFiler: HyperFiler = new HyperFiler(hyperFilerOptions);
