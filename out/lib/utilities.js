 ...
 */
function resolveAbsoluteUrl(url, protocol, baseUrl) {
 ...
 */
function getBaseUrl(url, protocol) {
    switch (protocol) {
        case 'file:': {
 ...
 */
function determineMimeType(url, bytes) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // instead.
        const magicNumberFileTypeResult = bytes === null
            ? null
            : yield FileType.fromBuffer(bytes);
        ...
        const fileContents = bytes.toString();
...
exports.parseSrcsetUrls = parseSrcsetUrls;
/**
...
function getDoctype(document) {
    const doctypeElement = document.doctype;
