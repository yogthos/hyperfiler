 ...
 */
function minifyWebp(bytes, jpegQuality, allowWebp, webpQuality) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (allowWebp === true) {
            const minifiedWebpBytes = yield genericImageMinifiers
                .minifyImageToWebp(bytes, image_extensions_1.ImageExtension.WEBP, webpQuality);
...
exports.minifyWebp = minifyWebp;
//# sourceMappingURL=webp-minifiers.js.map