...
exports.LZMA = (() => {
    ...
    function $init(this$static, input, output, length_0, mode) {
        ...
        encoder._writeEndMark = typeof exports.LZMA.disableEndMark === 'undefined';
    ...
    function $Create_3(this$static, historySize, keepAddBufferBefore, matchMaxLen, keepAddBufferAfter) {
        let cyclicBufferSize;
        let hs;
        let windowReservSize;
    ...
    function $ShiftLow(this$static) {
        let temp;
        const LowHi = lowBits_0(shru(this$static.Low, 32));
    ...
    const get_mode_obj = (() => {
        ...
        return (mode) => modes[mode - 1] || modes[6];
    })();
    return {
        compress,
        decompress,
